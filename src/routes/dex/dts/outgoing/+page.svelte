            ...
            <div class="col">
                <nav style="--bs-breadcrumb-divider: '>';">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active">(Tracker) Outgoing</li>
                    </ol>
                </nav>
            </div>
            <div class="col-auto"><button class="btn btn-primary btn-sm px-3"><i class="bi bi-plus-lg me-2"></i>Create</button></div>
        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-auto">
                        <div class="form-check">
                            ...
                            <i title="This will include document no, document name, and document details in your query." class="bi bi-question-circle-fill ms-1 text-primary"></i>
                        </div>
                    </div>
                </div>
                <input type="text" class="form-control form-control-sm" placeholder="Search by transaction no., tile, or description..." id="docmngtMyDocumentsSearchInput" />
            </div>
