<script>
    ...
    async function populateDocumentDetails() {
        try {
            const result = await App.API.post('/dex/dts/outgoing/create/document-details', {
                doc_no: docNo,
            });
...
<Auth bind:me={auth} warning="You are about to post a transaction." />
...
<j.RowCol>
    ...
    <nav style="--bs-breadcrumb-divider: '>';">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item small"><a href="/dex/dts/outgoing">(Tracker) Outgoing</a></li>
...
<j.Card>
    ...
    <j.RowCol endx>
        <div class="d-flex gap-2">
            ...
            <j.Button label="Post" loadinglabel="Posting" icon="bi-check-lg" loading={saving} onClick={save} />
        </div>
    </j.RowCol>
</j.Card>
