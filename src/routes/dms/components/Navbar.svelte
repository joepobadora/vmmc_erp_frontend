...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary shadow-sm py-1 px-2">
    <div class="container-fluid">
        <a class="navbar-brand" href="/dms">VMMC ERP - DMS</a>
        ...
        <div class="dropdown text-light">
            ...
            <ul class="dropdown-menu dropdown-menu-end shadow-sm" aria-label="menu dropdown">
                ...
                <li>
                    <a class="dropdown-item small" href="/home">
                ...
                <li>
                    <a class="dropdown-item small" href="/" data-bs-toggle="modal" data-bs-target={`#${modalId}`}>
