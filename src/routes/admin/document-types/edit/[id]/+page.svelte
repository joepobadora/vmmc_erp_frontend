...
<Auth bind:me={auth} warning="You are about to update a document type." />
...
<j.Card>
    ...
    <j.RowCol>
        ...
        <div>
            <j.Button label="Delete Type" variant="danger" loadinglabel="Deleting" icon="bi-x-lg" loading={deleting} onClick={destroy} />
        </div>
    </j.RowCol>
    <j.RowCol endx>
