...
<j.Card>
    ...
    <j.Row>
        <j.Col span="6">
            ...
            <input bind:value={account.username} class="form-control form-control-sm" id="username" disabled />
        </j.Col>
    </j.Row>
    <j.Row>
        <j.Col span="6">
            <label for="office" class="form-label small">Office</label>
            <input bind:value={account.office} class="form-control form-control-sm" id="office" disabled />
